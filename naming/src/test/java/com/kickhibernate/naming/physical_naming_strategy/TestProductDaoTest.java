...
public class TestProductDaoTest {
    ...
    public static void init() {
        sessionFactory = HbmUtil.getSessionFactory("hibernate.physical_naming_strategy","com.kickhibernate.naming.physical_naming_strategy.CustomPhysicalNamingStrategy", Product.class);
